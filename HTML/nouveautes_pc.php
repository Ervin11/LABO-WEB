...
<body >
	...
	<h1 class="titre_ps4">Nouveautés - PC</h1>
	...
	<div class="table-container">
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/pure.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">Pure Farming</span>
					<p><span class="prix">29,99 €</span></p>
				</div>
			</a>
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/wow.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">WoW : Battle for Azeroth</span>
					<p><span class="prix">46,99 €</span></p>
				</div>
			</a>
				
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/flight.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">Flight Sim World</span>
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/survive.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">Surviving Mars</span>
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/ffxv.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">Final Fantasy XV</span>
					<p><span class="prix">49,99 €</span></p>
				</div>
			</a>
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/extinction.jpg">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">Extinction</span>
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/pc/mx1.png">
					<p><span class="console" style="color: white;">PC</span></p>
					<span class="titre">MX vs ATV : All Out</span>
					<p><span class="prix">39,99 €</span></p>
				</div>
			</a>
