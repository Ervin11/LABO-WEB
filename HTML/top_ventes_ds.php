...
<body >
	...
	<h1 class="titre_ps4">Top des ventes - 3DS / 2DS</h1>
	...
	<div class="table-container">
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/ds/miitopia.jpg">
					<p><span class="console" style="color: white;">3DS</span></p>
					<span class="titre">Miitopia</span>
			...
			<a href="god_of_war.php">	
				<div class="nail">
					</br><img src="../img/ds/kirby.jpg">
					<p><span class="console" style="color: white;">3DS</span></p>
					<span class="titre">Kirby Triple Deluxe</span>
					<p><span class="prix">19,99 €</span></p>
				</div>
			</a>
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/ds/mario_kart.jpg">
					<p><span class="console" style="color: white;">3DS</span></p>
					<span class="titre">Mario Kart 7</span>
		...
		<div class="table-container">
			...
			<a href="deus.php">
				<div class="nail">
					</br><img src="../img/ds/pikachu.jpg">
					<p><span class="console" style="color: white;">3DS</span></p>
					<span class="titre">Détective Pikachu</span>
					<p><span class="prix">44,99 €</span></p>
				</div>
			</a>
