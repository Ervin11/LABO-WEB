...
<body >
	...
	<h1 class="titre_ps4">Nouveautés - XBOX ONE</h1>
	...
	<div class="table-container">
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/xbox1/extinction.jpg">
					<p><span class="console" style="color: white;">Xbox One</span></p>
			...
			<a href="farcry.php">
				<div class="nail">
					</br><img src="../img/xbox1/titan.png">
					<p><span class="console" style="color: white;">Xbox One</span></p>
			...
			<a href="god_of_war.php">	
				<div class="nail">
					</br><img src="../img/xbox1/sea.jpg">
					<p><span class="console" style="color: white;">Xbox One</span></p>
					<span class="titre">Sea of Thieves</span>
					<p><span class="prix">69,99 €</span></p>
				</div>
			</a>
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/xbox1/blob.png">
					<p><span class="console" style="color: white;">Xbox One</span></p>
					<span class="titre">De Blob 2</span>
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/xbox1/injustice.jpg">
					<p><span class="console" style="color: white;">Xbox One</span></p>
					<span class="titre">Injustice 2</span>
					<p><span class="prix">59,99 €</span></p>
				</div>
			</a>
			...
			<a href="god_of_war.php">	
				<div class="nail">
					</br><img src="../img/xbox1/final.jpg">
					<p><span class="console" style="color: white;">Xbox One</span></p>
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/xbox1/survive.jpg">
					<p><span class="console" style="color: white;">Xbox One</span></p>
