...
<body >
	...
	<h1 class="titre_ps4">Nouveautés - Nintendo Switch</h1>
	...
	<div class="table-container">
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/switch/penny.jpg">
					<p><span class="console" style="color: white;">Switch</span></p>
					<span class="titre">Penny-punching Princess</span>
					<p><span class="prix">39,99 €</span></p>
				</div>
			</a>
			...
			<a href="farcry.php">
				<div class="nail">
					</br><img src="../img/switch/scribble.jpg">
					<p><span class="console" style="color: white;">Switch</span></p>
					<span class="titre">Scribblenauts Showdown</span>
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/switch/atelier.jpg">
					<p><span class="console" style="color: white;">Switch</span></p>
					<span class="titre">Atelier Lydie and Suelle</span>
