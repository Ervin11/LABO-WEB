...
<body >
	...
	<h1 class="titre_ps4">Top des ventes - XBOX 360</h1>
	...
	<div class="table-container">
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/xbox/minecraft.jpg">
					<p><span class="console" style="color: white;">Xbox 360</span></p>
					<span class="titre">Minecraft</span>
					<p><span class="prix">19,90 €</span></p>
				</div>
			</a>
		...
		<div class="table-container">
			...
			<a href="detroit.php">	
				<div class="nail">
					</br><img src="../img/xbox/cod_bo3.jpg">
					<p><span class="console" style="color: white;">Xbox 360</span></p>
					<span class="titre">COD : Black Ops 3</span>
					<p><span class="prix">16,90 €</span></p>
				</div>
			</a>
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/xbox/cod_bo2.jpg">
					<p><span class="console" style="color: white;">Xbox 360</span></p>
					<span class="titre">COD : Black Ops 2</span>
					<p><span class="prix">17,54 €</span></p>
				</div>
			</a>
