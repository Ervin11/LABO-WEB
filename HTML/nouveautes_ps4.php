...
<body >
	...
	<h1 class="titre_ps4">Nouveautés - PS4</h1>
	...
	<div class="table-container">
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/ps4/witch.jpg">
					<p><span class="console" style="color: white;">PS4</span></p>
					<span class="titre">The Witch And THK 2</span>
		...
		<div class="table-container">
			...
			<a href="aot.php">
				<div class="nail">
					</br><img src="../img/ps4/rad.jpg">
					<p><span class="console" style="color: white;">PS4</span></p>
					<span class="titre">Rad Rogers</span>
			...
			<a href="deus.php">
				<div class="nail">
					</br><img src="../img/ps4/bravo.jpg">
					<p><span class="console" style="color: white;">PS4</span></p>
					<span class="titre">Bravo Team VR</span>
					<p><span class="prix">39,99 €</span></p>
				</div>
			</a>
			...
			<a href="detroit.php">	
				<div class="nail">
					...
					<p><span class="console" style="color: white;">PS4</span></p>
					<span class="titre">Far cry 5 - Deluxe</span>
					<p><span class="prix">69,99 €</span></p>
				</div>
			</a>
